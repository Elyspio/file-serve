...
export const PublicFilesApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		 ...
		 */
		addFile: async (filename: string, location: string, file: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PublicFilesApiFp = function (configuration?: Configuration) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async addFile(filename: string, location: string, file: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileModel>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.addFile(filename, location, file, options);
		 ...
		 * @throws {RequiredError}
		 */
		async getFile(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileModel>> {
		 ...
		 * @throws {RequiredError}
		 */
		async getFiles(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FileModel>>> {
...
export const PublicFilesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		addFile(filename: string, location: string, file: any, options?: any): AxiosPromise<FileModel> {
			return localVarFp.addFile(filename, location, file, options).then((request) => request(axios, basePath));
		},
		/**
		 *
		 * @param {string} id
		 ...
		 * @throws {RequiredError}
		 */
		getFile(id: string, options?: any): AxiosPromise<FileModel> {
		 ...
		 * @throws {RequiredError}
		 */
		getFiles(options?: any): AxiosPromise<Array<FileModel>> {
...
export class PublicFilesApi extends BaseAPI {
	 ...
	 */
	public addFile(filename: string, location: string, file: any, options?: AxiosRequestConfig) {
		return PublicFilesApiFp(this.configuration)
			.addFile(filename, location, file, options)
...
export const UserFilesApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		addFile: async (filename: string, location: string, file: any, authenticationToken?: string, authenticationToken2?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
			// verify required parameter 'filename' is not null or undefined
			assertParamExists("addFile", "filename", filename);
			// verify required parameter 'location' is not null or undefined
			assertParamExists("addFile", "location", location);
...
export const UserFilesApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async addFile(
			...
			authenticationToken2?: string,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileModel>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.addFile(filename, location, file, authenticationToken, authenticationToken2, options);
			return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
		},
		/**
		 *
...
export const UserFilesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		addFile(filename: string, location: string, file: any, authenticationToken?: string, authenticationToken2?: string, options?: any): AxiosPromise<FileModel> {
			return localVarFp.addFile(filename, location, file, authenticationToken, authenticationToken2, options).then((request) => request(axios, basePath));
		},
		/**
		 *
		 * @param {string} id
		 ...
		 * @throws {RequiredError}
		 */
		getFile(id: string, authenticationToken?: string, authenticationToken2?: string, options?: any): AxiosPromise<FileModel> {
		 ...
		 * @throws {RequiredError}
		 */
		getFiles(authenticationToken?: string, authenticationToken2?: string, options?: any): AxiosPromise<Array<FileModel>> {
...
export class UserFilesApi extends BaseAPI {
	 ...
	 */
	public addFile(filename: string, location: string, file: any, authenticationToken?: string, authenticationToken2?: string, options?: AxiosRequestConfig) {
		return UserFilesApiFp(this.configuration)
			.addFile(filename, location, file, authenticationToken, authenticationToken2, options)
			.then((request) => request(this.axios, this.basePath));
	}
