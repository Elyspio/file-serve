				...
				<Grid container direction={"column"} alignItems={"center"} spacing={6}>
					...
					<Grid item xs={12} container>
						<FormControl fullWidth>
							...
							<Select labelId="settings-theme-label" id="settings-theme-select" value={fileType} label="Theme" fullWidth onChange={(e) => setFileType(e.target.value as any)}>
					...
					<Grid item xs={12} container justifyContent={"center"}>
						<Button color={"primary"} variant={"outlined"} disabled={filename.length === 0 || emptyFile} onClick={create}>
							Create
						</Button>
					</Grid>
				</Grid>
