...
public interface IFileService
{
    ...
    ///     Add a public file
    /// </summary>
    Task<string> AddPublicFile(string filename, string mime, Stream content);
    ...
    Task<string> AddUserFile(string username, string filename, string mime, Stream content);
